...
num_training_iterations = 10000 #30000 # Number of training iterations
...
MOBILITY_SIMS = {
    "speed" : [0.0, 15.0] #[30] #[0.0, 15.0, 30.0]
}
...
for speed in MOBILITY_SIMS["speed"]:
    # Baseline - Perfect CSI
    plt.semilogy(ebno_dbs, BLER['baseline-perfect-csi'][i], label="Perfect CSI - {}[m/s]".format(speed))
    # Baseline - LS Estimation
    plt.semilogy(ebno_dbs, BLER['baseline-ls-estimation'][i], label="LS Estimation - {}[m/s]".format(speed))
    # Neural receiver
