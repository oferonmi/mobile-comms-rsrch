    ...
    switch sceEnvType
        ...
        case 'UMiLOS'
            ...
            if (txRxDistance< 10 || txRxDistance> 5000)
                pathlossValue = 32.9 + 19.2*log10(txRxDistance) + ...
                                20.8*log10(carrierFreq)+ 2*randn;
            end
        ...
        case 'UMiNLOS'
            ...
            if (txRxDistance< 10 || txRxDistance> 5000)
                pathlossValue = 32.4 + 31.9*log10(txRxDistance/refDist)...
                                + 20*log10(carrierFreq)+ 8.2*randn;
            end
        ...
        case 'UMaNLOS'
            ...
            elseif (txRxDistance < 10 || txRxDistance > 5000)
                pathlossValue = 32.4 +20*log10(carrierFreq)...
                                +30*log10(txRxDistance) + 7.8*randn;
            end
        ...
        case 'RMaLOS'
            pathlossValue = 20*log10(4*pi*refDist*carrierFreq*1e9/c) + ...
                23.1*(1-0.03*((BSheight-35)/35))*log10(txRxDistance) + 1.7*randn;
        ...
        case 'RMaNLOS'
             pathlossValue = 20*log10(4*pi*refDist*carrierFreq*1e9/c) + ....
                    30.7*(1-0.049*((BSheight-35)/35))*log10(txRxDistance) + 6.7*randn;
